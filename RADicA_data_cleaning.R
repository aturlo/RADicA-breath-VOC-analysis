...
b1_all <- b_all %>% filter(Date < '2020-10-01')
b2_all <- b_all %>% filter(Date > '2020-10-01')

# remove one of each duplicated sample pairs (repeated due to analysis failure)
duplicates_b1 <- c('200320_RaDICA_RAD094_B1_434919_1', '200320_RaDICA_RAD074_B1_609366_1', '200417_RaDICA_RAD114_S2_367150_1')

b1_all <- b1_all %>% filter(Sample %ni% duplicates_b1)

duplicates_b2 <- c('220318_24_RADicA_S1_RAD226_367150')
